...
const BentoSection = () => {
  const boxes = [
    {
      ...
      bgClass: "bg-black/80",
      description:
        "Data clean up, modeling/regressions, and other statistical analyses.",
    ...
    },
    {
      ...
      imageStyle:
        "top-[55%] left-1/2 w-2/3 opacity-65 -translate-x-1/2 -translate-y-1/2 min-h-[200px]",
      title: "Interviews",
      bgClass: "bg-black/80",
      description:
        "Scheduling, conducting, and assessment of online and in-person interviews.",
    ...
    },
    {
      imageSrc: figroLogo,
      imageStyle:
        "top-[55%] left-1/2 w-2/3 opacity-65 -translate-x-1/2 -translate-y-1/2 min-h-[200px] blur-[1px]",
    ...
    {
      title: "Card Sorting",
      description: "User-generated groupings to increase intuitive layouts.",
      bgClass: "bg-black/80",
      className: " col-span-12 md:col-span-12 lg:col-span-8 min-h-[300px]",
    ...
    },
    {
      ...
      className: "col-span-12 md:col-span-6 lg:col-span-4 min-h-[300px]",
      backgroundContent: (isHovered) => (
        <CodingLanguages isHovered={isHovered} />
      ),
    },
    {
      //imageSrc: researchobsLogo,
      ...
      className: "col-span-12 md:col-span-6 lg:col-span-4 min-h-[300px]",
      backgroundContent: (isHovered) => (
        <PersonasSections isHovered={isHovered} />
      ),
    },
    {
      //imageSrc: researchobsLogo,
      ...
      description: "Understanding the process to find a solution.",
      bgClass: "bg-black/80",
      className: "col-span-12 md:col-span-12 lg:col-span-4 min-h-[300px]",
      backgroundContent: (isHovered) => (
        <ArrowArcAnimation isHovered={isHovered} />
      ),
    },
  ];
  ...
  return (
    <div className="px-6 max-w-screen-xl mx-auto">
      <h2 className="custom-shadow-white text-gray-900  font-semibold py-6 text-2xl leading-snug text-right">
        Selected skills from recent projects
      </h2>
