  ...
  const boxes = [
    {
      ...
      title: 'Data Analyses',
      bgClass: 'bg-black/80',
      description: 'Data clean up, modeling/regressions, and other statistical analyses.',
    ...
    },
    {
      ...
      title: 'Interviews',
      bgClass: 'bg-black/80',
      description: 'Scheduling, conducting, and assessment of online and in-person interviews.',
