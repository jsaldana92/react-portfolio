...
const BentoBox = ({
  ...
  return (
    <div
      className={`relative h-full border ${borderClass} rounded-xl overflow-hidden p-4 ${bgClass} hover:bg-white/5 transition ${className}`}
...
const BentoSection = () => {
  const boxes = [
    ...
    <div className="px-6 max-w-screen-xl mx-auto">
      <h2 className="custom-shadow-white text-white py-6 text-2xl leading-snug text-right">Selected skills from recent projects</h2>
