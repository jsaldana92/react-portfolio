    ...
    <div className="w-full">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-5xl font-extrabold">
            ...
            <span className="bg-gradient-to-r from-[#e3a730] to-[#b55f5f] bg-clip-text text-transparent">
              {" "}
              Improve Data Collection Experience
            </span>
          </h1>
          <p className="text-xl text-gray-700 italic">
            Multiple researchers reported assistants having difficulty
            collecting data and also reported collection being ineffective and
          ...
          <div className="relative flex justify-start">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-xl">
              <p className="text-lg md:text-xl text-gray-800">
                Older research facilities often rely on non-cloud based local
                data storage to increase cyber security and therefore{" "}
                <strong className="text-blue-500">manually collect data</strong>{" "}
          ...
          <div className="relative flex justify-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-xl text-center">
              <p className="text-lg md:text-xl font-semibold text-gray-800">
                ...
                with research staff to determine the most common friction points
                in data collection. This was followed by{" "}
                <strong className="text-blue-500">
                  {" "}
                  beta-test interviews
                </strong>{" "}
                to gauge my solutions' (DataPuller) impact and engagement level.
                Lastly, I conducted{" "}
                <strong className="text-blue-500">
                  {" "}
                  post-launch interviews and questionnaires
                </strong>{" "}
                to verify the effectiveness of beta-test changes and guide
                future iterations.
              </p>
            </div>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 mt-12 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="mt-2 text-gray-700">.csv</p>
            <p className="mt-2 text-gray-700">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="mt-2 text-gray-700">
              Pop-ups for Errors and Successes
            </p>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto mt-4 mb-12 px-6">
        <div className="w-full mx-auto">
          <h1 className="text-2xl font-bold custom-shadow-white text-[#000000] text-center">
            ...
            <span className="text-blue-500">
              {" "}
              overfixate on the long start up time (12 seconds){" "}
            </span>
        ...
        <div className="w-full mt-4 mx-auto">
          <h1 className="text-2xl font-bold custom-shadow-white text-[#000000] text-center">
            ...
            regardless of optimization. Since a faster launch time is crucial,
            the app needs to be
            <span className="text-blue-500"> recoded </span>
            in a<span className="text-blue-500"> faster language, </span>
            such as
      ...
      <section className="max-w-4xl mx-auto mt-4 mb-12 px-6">
        <div className="w-full mx-auto">
          <h1 className="text-2xl font-bold custom-shadow-white text-[#000000] text-center">
            Using
            <span className="text-[#cc4100]"> Rust </span> to lower launch times
            to
          ...
          <div className="flex flex-col items-start space-y-4 md:w-1/2">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg w-full">
              <p className="text-lg font-semibold text-custom-shadow-sm text-gray-800">
                Improving a quantitative measure (data collection speed) alone
                is <span className="underline">not enough</span> to over come
        ...
        <div className="flex flex-col space-y-8 pb-16">
          ...
          <div className="w-full mx-auto mb-8">
            <p className="text-4xl  font-bold custom-shadow-white text-[#000000] text-center">
              ...
              <span className="text-[#f28e0b]"> engagement</span> to overcome
              established cognitive biases.
            </p>
          </div>
        </div>
      </section>
