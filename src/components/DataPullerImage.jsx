...
export default function DataPullerImage() {
  ...
  const titles = {
  'Speed': 'DataPuller Becomes More Efficient as More Data Is Needed from Different Projects',
  'Enjoyment/Usage': 'DataPuller Is Not Seen as an Improvement and Is Unlikely to Be Used'
};

  const getImage = () => {
    return selectedTab === 'Enjoyment/Usage' ? enjoymentImg : speedImg;
  };
