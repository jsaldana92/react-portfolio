...
const Card = ({ position, targetPosition, label, isHovered, screenSize, color }) => {
  const ref = useRef();
...
const labels = [
  'Note', 'Manipulate', 'Play', 'Groom',
  'Sexual', 'Aggress', 'Feed', 'Share',
  'Locomote', 'Inactive', 'Contact', 'Proximity'
];
