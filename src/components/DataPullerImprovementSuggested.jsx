...
export default function DataPullerImprovementSuggested() {
  const tabs = ['Most Wanted Improvement', 'Most Common Suggested Feature', 'General Feedback'];
  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-8">
      ...
      {/* Content area */}
      {selectedTab === 'Most Wanted Improvement' && renderQuotes(improvementQuotes)}
      {selectedTab === 'Most Common Suggested Feature' && renderQuotes(featureQuotes)}
      {selectedTab === 'General Feedback' && renderQuotes(generalFeedbackQuotes)}
    </section>
  );
}
