...
export default function ROPreliminaryInterview() {
  ...
  const endUserQuotes = [
    ...
    {
      text: '"The tablets lose charge really quickly and each groups pretty much has only one tablet assigned to it, which makes data collection difficult since we cannot freely switch between the tablets as needed."',
